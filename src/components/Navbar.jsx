  ...
  return (
    ...
    mmd:w-[100%]`}>
      <nav className='md:max-w-[715px] lg:max-w-[960px] mmd:max-w-[960px] mx-auto flex md:justify-between py-[1.5rem] mmd:py-[0.6rem] mmd:px-6'>
        <a href='#' className={`${showNavbarData ? 'block' : 'hidden'} md:block font-poppins font-poppins-500 mmd:text-[1.2rem] text-[1rem] hover:text-firstColor`}>Ritik</a>
        <div className='flex gap-x-3 mmd:flex-col mmd:w-full mmd:gap-y-3'>
          ...
          <div className={`flex flex-row-reverse gap-x-3 ${!showNavbarData ? 'w-full' : null} `}>
            ...
            <div onClick={changePageModeColor} className={`cursor-pointer hover:text-firstColor ${showNavbarData ? 'block' : 'hidden'} md:block`}>
              {
